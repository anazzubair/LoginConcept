...
class TextResize : Transition {
        ...
        val listener = object : AnimatorListenerAdapter() {
            override fun onAnimationEnd(animation: Animator) {
                textView.apply {
                    ...
                    setLinkTextColor(linkColors)
                }
            }

            override fun onAnimationPause(animation: Animator) {
                textView.apply {
                    setTextSize(TypedValue.COMPLEX_UNIT_PX, drawable.fontSize)
                    ...
                    setTextColor(drawable.textColor)
                }
            }

            override fun onAnimationResume(animation: Animator) {
                textView.apply {
                    setTextSize(TypedValue.COMPLEX_UNIT_PX, finalFontSize)
                    setPadding(endData.paddingLeft, endData.paddingTop,
                            endData.paddingRight, endData.paddingBottom)
                    setTextColor(endData.textColor)
                }
            }
        }
    ...
    private class SwitchBitmapDrawable(private val view: TextView, gravity: Int,
        ...
        private fun getTranslationPoint(gravity: Int, start: Float, end: Float, dim: Float,
            ...
            when (gravity) {
                ...
                Gravity.END, Gravity.BOTTOM -> return end - dim * scale
                Gravity.START, Gravity.TOP -> return start
                else -> return start
            }
        }
    }
    ...
    companion object {
        ...
        private fun interpolate(start: Float, end: Float, fraction: Float): Float = (start + fraction * (end - start))
    }
}